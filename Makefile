...
.PHONY: run
run:
	go run ./main.go --in samples/image-content-margin/layout.json --out samples/image-content-margin/output.pdf --ttf fonts/TakaoPGothic.ttf
	...
	#go run ./main.go --in samples/text-content-margin/layout.json --out samples/text-content-margin/output.pdf --ttf fonts/TakaoPGothic.ttf
...
exec-samples:
	...
	./bin/$(BIN)-dev-mac --in samples/image-content-margin/layout.json --out samples/image-content-margin/output.pdf --ttf fonts/TakaoPGothic.ttf
	...
	./bin/$(BIN)-dev-mac --in samples/text-content-margin/layout.json --out samples/text-content-margin/output.pdf --ttf fonts/TakaoPGothic.ttf
